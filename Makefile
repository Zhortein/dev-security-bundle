...
bundle-validate: ## Validate bundle structure
	...
	@test -f src/ZhorteinOvhApiBundle.php || (echo "❌ Bundle class missing" && exit 1)
	@test -f src/DependencyInjection/ZhorteinOvhApiExtension.php || (echo "❌ Extension class missing" && exit 1)
	@test -f src/DependencyInjection/Configuration.php || (echo "❌ Configuration class missing" && exit 1)
	@test -f src/Service/OvhApiService.php || (echo "❌ OvhApiService class missing" && exit 1)
